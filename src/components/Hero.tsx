    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-7xl font-bold tracking-tighter mb-8 leading-[1.1] bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-gray-500"
        >
          {HERO_CONTENT.header}
        </motion.h1>
